      ...
      <div className="mt-8 sm:mt-16 border-t border-gray-200 dark:border-gray-700 bg-black/70 dark:bg-black/50 backdrop-blur-sm">
        <div className="py-6 sm:py-8 px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div>
              <h4 className="font-semibold text-sm sm:text-base text-white mb-2 sm:mb-3">{t('footer.aboutUs')}</h4>
            ...
            <div>
              <h4 className="font-semibold text-sm sm:text-base text-white mb-2 sm:mb-3">{t('footer.contact')}</h4>
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-white">
                <li><a href={`mailto:${siteMetadata.email}`} className="hover:text-primary-600 break-all">{siteMetadata.email}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-sm sm:text-base text-white mb-2 sm:mb-3">{t('footer.follow')}</h4>
            ...
            <div>
              <h4 className="font-semibold text-sm sm:text-base text-white mb-2 sm:mb-3">{t('footer.legal')}</h4>
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-white">
          ...
          {/* Copyright */}
          <div className="pt-4 sm:pt-6 border-t border-white/20 dark:border-gray-700 text-center">
